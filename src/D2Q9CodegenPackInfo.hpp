...
class D2Q9CodegenPackInfo : public ::walberla::communication::UniformPackInfo
{
public:
    D2Q9CodegenPackInfo( BlockDataID pdfsID_ )
        : pdfsID(pdfsID_)
    {};
    virtual ~D2Q9CodegenPackInfo() {}
