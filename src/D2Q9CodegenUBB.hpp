...
public:
    struct IndexInfo { 
        ...
        int32_t y;
        int32_t dir;
        IndexInfo(int32_t x_, int32_t y_, int32_t dir_) : x(x_), y(y_), dir(dir_) {}
    ...
    D2Q9CodegenUBB( const shared_ptr<StructuredBlockForest> & blocks,
                   BlockDataID pdfsID_, double u_w, double v_w)
        : pdfsID(pdfsID_), u_w_(u_w), v_w_(v_w)
    {
        auto createIdxVector = []( IBlock * const , StructuredBlockStorage * const ) { return new IndexVectors(); };
        indexVectorID = blocks->addStructuredBlockData< IndexVectors >( createIdxVector, "IndexField_D2Q9CodegenUBB");
    }
