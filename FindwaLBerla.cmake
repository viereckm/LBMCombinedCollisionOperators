...
if( WALBERLA_DIR )
    ...
    # this command builds waLBerla (again) in the current build directory in the subdirectoy walberla
    add_subdirectory( ${WALBERLA_DIR} walberla )

    waLBerla_import()
    # Adds the 'src' and 'tests' directory of the current app
    ...
    message( FATAL_ERROR "waLBerla not found - Use 'cmake -DWALBERLA_DIR=path_to_waLBerla_sources path_to_application_sources' " )
endif()